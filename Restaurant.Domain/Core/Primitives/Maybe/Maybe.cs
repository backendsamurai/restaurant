namespace Restaurant.Domain.Core.Primitives.Maybe
{
    public sealed class Maybe<T> : IEquatable<Maybe<T>>
    {
        ...
        public T Value => HasValue
            ? _value : throw new InvalidOperationException("The value can not be accessed because it does not exist.");
        ...
        public bool Equals(Maybe<T>? other)
        {
            ...
            if (Value is null || other.HasNoValue)
                return false;
