...
{
    public Task<Result<List<OrderResponse>>> GetOrdersAsync(OrderStatus status = OrderStatus.Pending);
    ...
    public Task<Result<List<OrderResponse>>> GetOrderByDeskAsync(Guid deskId);
